...
#' PES Sample Event File
#'
#' A sample version of the file structure expected for the `pes_event_file`
#' parameter in the `pes_process` function. The user should recreate this file
